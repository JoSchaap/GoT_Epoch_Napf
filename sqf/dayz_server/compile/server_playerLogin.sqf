...
if(_isNew) then {
_inventory = [["M9","ItemFlashlightRed","ItemMap","ItemGPS","ItemToolbox"], ["15Rnd_9x19_M9","15Rnd_9x19_M9","15Rnd_9x19_M9","ItemBloodbag","ItemPainkiller","ItemAntibiotic","ItemAntibiotic","ItemPainkiller","ItemGoldBar","ItemGoldBar","ItemGoldBar","ItemGoldBar","ItemBandage","ItemBandage","ItemBandage"]];
};
